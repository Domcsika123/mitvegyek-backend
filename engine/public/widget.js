...
(function () {
  ...
  function injectStyles() {
    ...
    var css =
      ...
      "  font-size:13px;font-weight:700;color:#1a1a1a;background:#fff176;" +
      "  border-left:4px solid #f59e0b;border-radius:6px;padding:12px 16px;" +
      ...
      ".mv-widget-result-name{font-size:14px;font-weight:900;color:#fff;overflow:hidden;white-space:normal;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;text-shadow:0 1px 2px rgba(0,0,0,0.3);}" +
  ...
  async function handleRecommendClick() {
    ...
    try {
      ...
      if ((!items || items.length === 0) && (!alsoItems || alsoItems.length === 0)) {
        statusEl.textContent = notice || copy.emptyStateText;
